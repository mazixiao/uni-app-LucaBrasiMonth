...
/* 0 */
/*!*****************************************************!*\
  !*** D:/wechat_test/uni-app-LucaBrasiMonth/main.js ***!
  \*****************************************************/
...
/* 5 */
/*!*****************************************************!*\
  !*** D:/wechat_test/uni-app-LucaBrasiMonth/App.vue ***!
  \*****************************************************/
/*! no static exports found */
...
/* 6 */
/*!******************************************************************************!*\
  !*** D:/wechat_test/uni-app-LucaBrasiMonth/App.vue?vue&type=script&lang=js& ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var util_js = __webpack_require__(/*! utils/util.js */ 12);var _default =
    ...
    wx.getSystemInfo({
      success: function success(res) {
        ...
        "iPhone XR") || -1 != res.model.search("iPhone XS Max")) {
          _this.$options.globalData.isIphoneX = true;

        } else {
          _this.$options.globalData.isIphoneX = false;
        }
        console.log(res);
      } });
          ...
          if (res.ReturnCode == 0) {
            ...
            api_js.postReq(_data, function (res) {
              ...
              if (res.ReturnCode == 110) {
                _this.$options.globalData.LoginStatus = 1;
                console.log(_this.$options.globalData.LoginStatus, "this.globalData.LoginStatus");
              };

              if (res.Data) {
                if (res.Data[0].loginstatus == 0) {
                  _this.$options.globalData.LoginStatus = 0;
                  _this.$options.globalData.UserID = res.Data[0].userid;
                  _this.$options.globalData.Phone = res.Data[0].phone;
                  _this.$options.globalData.UserName = res.Data[0].nlikename;
                  _this.$options.globalData.HeadPortrait = res.Data[0].headportrait;
                  _this.$options.globalData.Status = res.Data[0].status;
                  // this.$options.globalData.Status = 2;

                  wx.setStorageSync("UserID", _this.$options.globalData.UserID);
                  if (_this.$options.globalData.Status == 2) {
                    console.log(2222);
                    uni.reLaunch({
...
/* 13 */
/*!**************************************************************************************!*\
  !*** D:/wechat_test/uni-app-LucaBrasiMonth/App.vue?vue&type=style&index=0&lang=css& ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
